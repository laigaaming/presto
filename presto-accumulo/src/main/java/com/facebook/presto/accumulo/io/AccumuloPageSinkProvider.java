        ...
        implements ConnectorPageSinkProvider
{
            ...
            throws PrestoException
    {
        try {
            ...
            return new AccumuloPageSink(connector, config, connector.securityOperations().getUserAuthorizations(config.getUsername()), client.getTable(tableHandle.toSchemaTableName()));
        }
